...
echo "2. Navigate to Setup menu on LCD:"
echo "   - [MENU] → [Setup] → [WiFi]"
echo "   - SSID: WeatherStation_Pi"
echo "   - Password: weather123"
echo "3. Configure Weather Service:"
echo "   - [MENU] → [Setup] → Select 'Ecowitt'"
echo "   - URL: www.ecowitt.net (keep default)"
echo "   - Interval: 1 Minute"
echo "   - Note: DNS will auto-redirect to Raspberry Pi"
echo ""
echo "Monitoring:"
echo "==========="
